...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("draft", "published", "archived", name="newsstatus"), nullable=False, server_default="draft"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("upcoming", "ongoing", "completed", "cancelled", name="eventstatus"), nullable=False, server_default="upcoming"),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.text("CURRENT_TIMESTAMP")),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.text("CURRENT_TIMESTAMP")),
